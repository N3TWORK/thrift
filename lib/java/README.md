...
Or the same on the command line:
    ...
    ./gradlew -Pmaven-repository-url=https://nexus.n3twork.com/repository/maven-releases/ -Prelease=true -Pthrift.version=0.10.0-N3-MODIFIED-<version> -x test uploadArchives
